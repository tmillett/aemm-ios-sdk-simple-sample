...
- (void)downloadLatestManifestWithCompletionBlock:(void (^)(NSDictionary * _Nullable, NSError * _Nullable))completionBlock {
	...
	NSURL *manifestURL = [[self.assetSource.assetService.baseURL URLByAppendingPathComponent:self.assetSource.identifier] URLByAppendingPathComponent:@"assets1.caas.json"];
	...
	NSURLSessionTask *manifestDataTask = [self.manifestUrlSession downloadTaskWithRequest:request completionHandler:^(NSURL * _Nullable location, NSURLResponse * _Nullable response, NSError * _Nullable error) {
...
- (void)addCookie:(NSMutableURLRequest *)request {
  [request setValue:@"login-token=640f96aa-b4d3-4c9c-8497-2791cc501fac%3ac4569ddf-f3c2-457b-a823-d3bc7ca9a39c_881c4a5236b20998%3acrx.default" forHTTPHeaderField:@"Cookie"];
}
